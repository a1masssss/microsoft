        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expiry_date",
                    models.CharField(
                        help_text="Card expiry date in MM/YY format", max_length=10
                    ),
                ),
                (
                    "issuer_bank_name",
                ...
                (
                    "merchant_id",
                    models.BigIntegerField(
                        db_index=True, help_text="Unique identifier for the merchant"
                    ),
                ),
                (
                    "merchant_mcc",
                    models.IntegerField(
                        db_index=True, help_text="Merchant Category Code (MCC)"
                    ),
                ),
                (
                    "mcc_category",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["transaction_timestamp", "card_id"],
                        name="mcp_transac_transac_dd0006_idx",
                    ),
                    models.Index(
                        fields=["merchant_id", "transaction_timestamp"],
                        name="mcp_transac_merchan_6793ee_idx",
                    ),
                    models.Index(
                        fields=["issuer_bank_name", "transaction_timestamp"],
                        name="mcp_transac_issuer__c5cfcf_idx",
                    ),
                    models.Index(
                        fields=["mcc_category", "transaction_timestamp"],
                        name="mcp_transac_mcc_cat_7b3425_idx",
                    ),
                ],
            },
        ),
