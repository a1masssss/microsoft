...
>(({ className, align = 'center', sideOffset = 4, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      sideOffset={sideOffset}
      className={cn(
        'z-50 w-64 rounded-xl bg-popover p-2 text-popover-foreground shadow-md outline-none animate-in dark:bg-[#303030] data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0 data-[state=open]:zoom-in-95 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
        className
      )}
      {...props}
    />
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 grid w-full max-w-[90vw] translate-x-[-50%] translate-y-[-50%] gap-4 border-none bg-transparent p-0 shadow-none duration-300 md:max-w-[800px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95',
        className
      )}
      {...props}
    >
      <div className="relative overflow-hidden rounded-[28px] bg-card p-1 shadow-2xl dark:bg-[#303030]">
        {children}
        <DialogPrimitive.Close className="absolute right-3 top-3 z-10 rounded-full bg-background/50 p-1 transition-all hover:bg-accent dark:bg-[#303030] dark:hover:bg-[#515151]">
          <XIcon className="h-5 w-5 text-muted-foreground dark:text-gray-200 dark:hover:text-white" />
...
export const PromptBox = React.forwardRef<HTMLTextAreaElement, PromptBoxProps>(
  ...
  return (
    <div
      className={cn(
        'flex flex-col rounded-[28px] border bg-white p-2 shadow-sm transition-colors cursor-text dark:border-transparent dark:bg-[#303030]',
        className
      )}
    >
      <input
        ...
        <Dialog open={isImageDialogOpen} onOpenChange={setIsImageDialogOpen}>
          <div className="relative mb-1 w-fit rounded-[1rem] px-1 pt-1">
            ...
            <button
              ...
              className="absolute right-2 top-2 z-10 flex h-4 w-4 items-center justify-center rounded-full bg-white/50 text-black transition-colors hover:bg-accent dark:bg-[#303030] dark:text-white dark:hover:bg-[#515151]"
      ...
      <textarea
        ...
        placeholder="Message..."
        className="custom-scrollbar min-h-12 w-full resize-none border-0 bg-transparent p-3 text-foreground placeholder:text-muted-foreground focus:ring-0 focus-visible:outline-none"
        {...props}
      />
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <PopoverTrigger asChild>
                    <button
                      type="button"
                      className="flex h-8 items-center gap-2 rounded-full p-2 text-sm text-foreground transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-ring dark:text-white dark:hover:bg-[#515151]"
                    >
            ...
            {activeTool && (
              <>
                ...
                <button
                  ...
                  className="flex h-8 items-center gap-2 rounded-full px-2 text-sm text-[#2294ff] transition-colors hover:bg-accent dark:text-[#99ceff] dark:hover:bg-[#3b4045]"
                >
            ...
            <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    type="submit"
                    disabled={!hasValue}
                    className="flex h-8 w-8 items-center justify-center rounded-full bg-black text-white transition-colors hover:bg-black/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-black/40 dark:bg-white dark:text-black dark:hover:bg-white/80 dark:disabled:bg-[#515151]"
                  >
